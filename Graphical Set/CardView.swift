...
class CardView: UIView {
    ...
    var color = Card.CardColor.green { didSet { setNeedsDisplay() }}
    var number = Card.CardNumber.one.rawValue { didSet { setNeedsDisplay() }}
    var shading = Card.CardShading.open { didSet { setNeedsDisplay() }}
    var symbol = Card.CardShape.diamond { didSet { setNeedsDisplay() }}
